...
const route = useRoute() // instancio route
const db = useFirestore() // me identifico usando vuefire
const docRef = doc(db, 'propiedades', route.params.id) // obtengo la referencia ald ocumento en firebase
const propiedad = useDocument(docRef)// uso eldocumento referenciado
